...
const HeroSection = () => {
  return (
    <div className="relative isolate w-full flex flex-col items-center gap-8 md:px-8 lg:px-16 px-6 md:py-10 lg:py-16 py-6 text-center overflow-hidden">
...
//                                             <span className="text-white md:text-base text-sm">{item}</span>
//                                         </div>
//                                     )
//                                 })}
//                             </div>
